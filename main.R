...
.run_interactive_spec <- function(args, fmt_opts) {
  ...
  repeat {
    ...
    if (identical(choice, "1")) {
      ...
      cat("Report 2: Top Contractors Performance Ranking (Top 15 by Total Cost, Minimum 5 Projects)\n\n")
      cat("Columns in the final CSV:\n")
      ...
      cat("Report 3: Annual Project Type Cost Overrun Trends (Grouped by FundingYear and TypeOfWork)\n\n")
      cat("Columns in the final CSV:\n")
